...
class Constants
{
    ...
    public const TYPE_DIRECTIONS = [
        0 => [
            'value' => '[1,1]',
            'text' => 'Добавление новых товаров (Работа с товарами Розетки)',
        ],
        1 => [
            'value' => '[1,2]',
            'text' => 'Добавление новых товаров (Работа с товарами Маркетплейса)',
        ],
        2 => [
            'value' => '[2,1]',
            'text' => 'Добавление/изменение информации в существующих товарах (Работа с товарами Розетки)',
        ],
        3 => [
            'value' => '[2,2]',
            'text' => 'Добавление/изменение информации в существующих товарах (Работа с товарами Маркетплейса)',
        ],
        4 => [
            'value' => '[3,1]',
            'text' => 'Перенос товаров (Работа с товарами Розетки)',
        ],
        5 => [
            'value' => '[3,2]',
            'text' => 'Перенос товаров (Работа с товарами Маркетплейса)',
        ],
        6 => [
            'value' => '[4,0]',
            'text' => 'Группировка товаров (Определяется типом задачи)',
        ],
        7 => [
            'value' => '[5,1]',
            'text' => 'Заливка фото с фотостудии (Работа с товарами Розетки)',
        ],
        8 => [
            'value' => '[6,2]',
            'text' => 'Проверка скрытых товаров (Работа с товарами Маркетплейса)',
        ],
        9 => [
            'value' => '[7,0]',
            'text' => 'Добавление нового портала/раздела фат-меню/категории товаров (Определяется типом задачи)',
        ],
        10 => [
            'value' => '[8,0]',
            'text' => 'Добавление/изменение информации в существующих порталах/фат-меню/категориях товаров (Определяется типом задачи)',
        ],
        11 => [
            'value' => '[9,0]',
            'text' => 'Добавление параметров/значений (Определяется типом задачи)',
        ],
        12 => [
            'value' => '[10,0]',
            'text' => 'Изменение существующих параметров/значений (Определяется типом задачи)',
        ],
        13 => [
            'value' => '[11,0]',
            'text' => 'Проектирование структуры (Определяется типом задачи)',
        ],
        14 => [
            'value' => '[12,1]',
            'text' => 'Добавление новых СЦ/изменение существующих СЦ (Работа с товарами Розетки)',
        ],
        15 => [
            'value' => '[13,0]',
            'text' => 'Добавление/изменение видео (Определяется типом задачи)',
        ],
        16 => [
            'value' => '[14,0]',
            'text' => 'Добавление/изменение размерной сетки (Определяется типом задачи)',
        ],
        17 => [
            'value' => '[15,0]',
            'text' => 'Добавление/изменение тегов (Определяется типом задачи)',
        ],
    ];
        ...
        0 => [
            ...
            'Отчеты' => [
                [
                    ...
                    'reportLoadYourTeam' => 'Выгрузка отчетов по своей команде (Контент)',
                ],
                [
            ...
            'Управление настройками' => [
                [
                    'SvDistributionUpdate' => 'Редактирование автораспределения задач (Контент)',
        ...
        1 => [
            ...
            'Отчеты' => [
                [
                    ...
                    'reportLoadYourTeam' => 'Выгрузка отчетов по своей команде',
                ],
                [
            ...
            'Управление настройками' => [
                [
                    'SvDistributionUpdate' => 'Редактирование автораспределения задач',
    ...
    public const REDIS_KEYS_VALUES = [
        ...
        'rozetka_categories_names_concatenated2f2317f7103bd28bbb76c4d92800d203' =>
            'a:2:{i:0;a:61:{' .
            'i:4626923;s:82:"Алкогольные напитки и продукты питания (4626923)";' .
            'i:80025;s:55:"Бытовая техника, интерьер (80025)";' .
            'i:2394297;s:40:"Дача, сад, огород (2394297)";' .
            'i:80253;s:48:"Компьютеры и ноутбуки (80253)";' .
            'i:4629305;s:44:"Красота и здоровье (4629305)";' .
            'i:4660666;s:55:"не должно выгружаться _old (4660666)";' .
            'i:1162030;s:58:"Одежда, обувь и аксессуары (1162030)";' .
            'i:84625;s:20:"Оружие (84625)";' .
            'i:4625734;s:42:"Офис, школа, книги (4625734)";' .
            'i:80260;s:66:"Подарки и товары для праздников (80260)";' .
            'i:4660651;s:63:"Рестораны и продуктовые сети (4660651)";' .
            'i:4628418;s:46:"Сантехника и ремонт (4628418)";' .
            'i:4655216;s:45:"Сельское хозяйство (4655216)";' .
            'i:4655025;s:24:"Скрытые (4655025)";' .
            'i:80262;s:41:"Скрытые категории (80262)";' .
            'i:4656380;s:37:"Скрытые товары (4656380)";' .
            'i:4627949;s:60:"Смартфоны, ТВ и электроника (4627949)";' .
            'i:4627893;s:42:"Спорт и увлечения (4627893)";' .
            'i:4627851;s:44:"Товары для бизнеса (4627851)";' .
            'i:88468;s:38:"Товары для детей (88468)";' .
            'i:2394287;s:38:"Товары для дома (2394287)";' .
            'i:4630262;s:40:"Услуги и сервисы (4630262)";' .
            'i:83850;s:39:"Уцененные товары (83850)";' .
            'i:2460392;s:30:"Канцелярия (2460392)";' .
            'i:2460402;s:72:"Архивирование и делопроизводство (2460402)";' .
            'i:2560747;s:59:"Банковские принадлежности (2560747)";' .
            'i:2514872;s:106:"Бейджи, брелоки-идентификаторы, настольные таблички (2514872)";' .
            'i:2514867;s:28:"Визитницы (2514867)";' .
            'i:4655272;s:48:"Досточки для оттиска (4655272)";' .
            'i:4641568;s:49:"Настольные картотеки (4641568)";' .
            'i:3167120;s:39:"Новая категория (3167120)";' .
            'i:2973057;s:39:"Новая категория (2973057)";' .
            'i:2581722;s:46:"Папки, регистраторы (2581722)";' .
            'i:4655242;s:50:"Пломбы и пломбираторы (4655242)";' .
            'i:2660622;s:52:"Разделители и закладки (2660622)";' .
            'i:4655266;s:22:"Сургуч (4655266)";' .
            'i:2514857;s:20:"Файлы (2514857)";' .
            'i:4630034;s:46:"Шило, нити и шпагаты (4630034)";' .
            'i:2514877;s:51:"Штемпельная продукция (2514877)";' .
            'i:4628926;s:22:"Датеры (4628926)";' .
            'i:4629073;s:63:"Оснастки, штампы стандартные (4629073)";' .
            'i:2898382;s:68:"Самонаборные штампы, кассы букв (2898382)";' .
            'i:2898387;s:63:"Штемпельные краски и подушки (2898387)";' .
            'i:2666302;s:53:"Архивные короба и боксы (2666302)";' .
            'i:4660667;s:56:"не должно выгружаться (old) (4660667)";' .
            'i:2581742;s:53:"Папки и файлы подвесные (2581742)";' .
            'i:2581737;s:37:"Папки-планшеты (2581737)";' .
            'i:2514862;s:43:"Папки пластиковые (2514862)";' .
            'i:2581727;s:60:"Папки-портфели, папки-боксы (2581727)";' .
            'i:2581732;s:45:"Папки-регистраторы (2581732)";' .
            'i:4626584;s:43:"Папки специальные (4626584)";' .
            'i:2595767;s:38:"Папки с файлами (2595767)";' .
            'i:4660668;s:54:"old не должно выгружаться (4660668)";' .
            'i:753399;s:53:"Аксессуары для алкоголя (753399)";' .
            'i:4652996;s:27:"Мини-бары (4652996)";' .
            'i:4653017;s:73:"Упаковки для алкогольных напитков (4653017)";' .
            'i:4653010;s:20:"Фляги (4653010)";' .
            'i:4628124;s:32:"Фото и видео (4628124)";' .
            'i:4660653;s:41:"Продуктовые сети (4660653)";' .
            'i:4660652;s:28:"Рестораны (4660652)";' .
            'i:4660669;s:81:"не использовать не должно выгружаться (4660669)";' .
            '}i:1;N;}',
