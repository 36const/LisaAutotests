...
class GeneralTester extends Actor
{
    ...
    public const POSITIONS = [
        ...
        'headSupervisor' => 'Руководитель супервайзеров',
        'moderator' => 'Сотрудник отдела модерации',
        'photoManager' => 'Сотрудник фотостудии',
        'productManager' => 'Продакт-менеджер',
        'seo' => 'Сотрудник seo-отдела',
        'supervisor' => 'Супервайзер',
        'system' => 'Система',
        'teamLead' => 'Руководитель направления (тимлид)',
    ];
