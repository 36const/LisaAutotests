...
class AttachmentsRequestViewCest
{
    ...
    public function AttachmentsRequestView(AcceptanceTester $I, Example $data, RequestView $view)
    {
        ...
        $I->attachFile('//input[@id="request-uploadedfiles"]', '.exe');
