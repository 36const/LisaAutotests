...
class POSTFromStatus6Cest
{
     ...
     *
     */
    public function POSTFromStatus6(FunctionalTester $I, \Codeception\Example $data)
    {
        ...
        !isset($providerData['requestCompleteBody']) ?:
            $I->sendPostIfRequestBodyExists($providerData['requestCompleteBody'], '/bpm/request/complete?id=1');
