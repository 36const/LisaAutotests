...
return [
    ...
    'case3' => [
        'setting' => [
            'description' => 'Невозможность перевода из "Ожидает (ризоны)" в "Частично выполнено / Выполнено" при ответе false в "Ждёт группировки", но оставшемся другом ризоне статуса 7',
        ],
