...
return [
    'case1' => [
        'setting' => [
            'description' => 'Создание отчёта с указанием только полей',
        ],
    ...
    'case2' => [
        'setting' => [
            'description' => 'Создание отчёта с указанием полей и направлений',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestBody' => [
                ...
                'Report[conditions][team_direction][]' => '4',
    ...
    'case3' => [
        'setting' => [
            'description' => 'Создание отчёта с указанием полей и типов',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestBody' => [
    ...
    'case4' => [
        'setting' => [
            'description' => 'Создание отчёта с указанием полей, типов и направлений',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestBody' => [
