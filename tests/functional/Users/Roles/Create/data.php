...
return [
    ...
    'case2' => [
        ...
        'provider_data' => [
            'requestBody' => [
                'AuthItem[description]' => 'Управление пользователями',
                'AuthItem[name]' => 'Управление пользователями',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '0',
                'AuthItem[rolePermissions][requestCheckHidden]' => '0',
                'AuthItem[rolePermissions][requestAddFatPortalCat]' => '0',
                'AuthItem[rolePermissions][transferPartialCompleteToClosed]' => '0',
    ...
    'case3' => [
        ...
        'provider_data' => [
            'requestBody' => [
                'AuthItem[description]' => 'Заявки',
                'AuthItem[name]' => 'Заявки',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '0',
                'AuthItem[rolePermissions][requestCheckHidden]' => '0',
                'AuthItem[rolePermissions][requestCheckHidden]' => '1',
                'AuthItem[rolePermissions][requestAddFatPortalCat]' => '0',
    ...
    'case4' => [
        ...
        'provider_data' => [
            'requestBody' => [
                'AuthItem[description]' => 'Переходы по статусам',
                'AuthItem[name]' => 'Переходы по статусам',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '0',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '1',
                'AuthItem[rolePermissions][requestCheckHidden]' => '0',
                'AuthItem[rolePermissions][requestAddFatPortalCat]' => '0',
    ...
    'case5' => [
        ...
        'provider_data' => [
            'requestBody' => [
                'AuthItem[description]' => 'Управление заявками',
                'AuthItem[name]' => 'Управление заявками',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '0',
                'AuthItem[rolePermissions][requestCheckHidden]' => '0',
                'AuthItem[rolePermissions][requestAddFatPortalCat]' => '0',
                'AuthItem[rolePermissions][transferPartialCompleteToClosed]' => '0',
    ...
    'case6' => [
        ...
        'provider_data' => [
            'requestBody' => [
                'AuthItem[description]' => 'Отчеты',
                'AuthItem[name]' => 'Отчеты',
                'AuthItem[rolePermissions][transferCompletedToInWork]' => '0',
                'AuthItem[rolePermissions][requestCheckHidden]' => '0',
                'AuthItem[rolePermissions][requestAddFatPortalCat]' => '0',
                'AuthItem[rolePermissions][transferPartialCompleteToClosed]' => '0',
