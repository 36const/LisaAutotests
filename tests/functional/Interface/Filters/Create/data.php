    ...
    'case1' => [
        ...
        'provider_data' => [
            'requestBody' => [
                ...
                'fields[8]' => '1',
                'fields[9]' => '1',
                'filter-select2' => ['id', 'status', 'awaiting_correction', 'subject', 'description', 'direction', 'amount_to_work', 'recommendations', 'reason_id', 'parent_id', 'supervisor_check_date', 'result_comment', 'supervisor_comment', 'report_period_id', 'team_direction', 'correction_comment', 'priority', 'sv_report_periods', 'cross_check_status', 'employee_code_1c'],
