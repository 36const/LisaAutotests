 ...
 * @group CronDifficultyCoefExportGenerate
 */
class CronDifficultyCoefExportGenerateCest
{
     ...
     */
    public function CronDifficultyCoefExportGenerate(RequestsTester $I, Example $data)
    {
