        ...
        'provider_data' => [
            ...
            'RabbitMQ' => [
                'lisa_sendOuterNotifications' => [
                    ...
                    '{"email":"test1115555@mail.coi","lang":"ru","event":"request-revision","fields":{"id":2,"type":"Обновление товаров","reasons":"!@#$%^&*()_+`=-]\'/[;.,}\"?{:><\\\|Другое ЛК","reason_comment":"!@#$%^&*()_+`-]\'/[;.,}\"?{:>\\\|абвгдеёжзийклмнопрстуфхцчшщъыьэюяєґїіАБВГДЕЁЖЗИЙКЛМНО","user_name":"Менеджер Розетки","link":"http://m2-front.dev.rozetka.com.ua/main/goods-manage/moderation?page=1&pageSize=20&id=2"},"requireAttachments":false}',
                    '{"email":"MF-3517-2@MF-3517-2.com","lang":"uk","event":"request-revision","fields":{"id":2,"type":"Оновлення товарів","reasons":"!@#$%^&*()_+`=-]\'/[;.,}\"?{:><\\\|Другое_ua ЛК","reason_comment":"!@#$%^&*()_+`-]\'/[;.,}\"?{:>\\\|абвгдеёжзийклмнопрстуфхцчшщъыьэюяєґїіАБВГДЕЁЖЗИЙКЛМНО","user_name":"Менеджер Розетки","link":"http://m2-front.dev.rozetka.com.ua/main/goods-manage/moderation?page=1&pageSize=20&id=2"},"requireAttachments":false}',
                ],
            ]
        ]
    ],
        ...
        'provider_data' => [
            ...
            'RabbitMQ' => [
                'lisa_sendOuterNotifications' => [
                    ...
                    '{"email":"test1115555@mail.coi","lang":"ru","event":"request-canceled","fields":{"id":2,"type":"Обновление товаров","reasons":"!@#$%^&*()_+`=-]\'/[;.,}\"?{:><\\\|Другое ЛК","reason_comment":"!@#$%^&*()_+`-]\'/[;.,}\"?{:>\\\|абвгдеёжзийклмнопрстуфхцчшщъыьэюяєґїіАБВГДЕЁЖЗИЙКЛМНО","user_name":"Менеджер Розетки","link":"http://m2-front.dev.rozetka.com.ua/main/goods-manage/moderation?page=1&pageSize=20&id=2"},"requireAttachments":false}',
                    '{"email":"MF-3517-2@MF-3517-2.com","lang":"uk","event":"request-canceled","fields":{"id":2,"type":"Оновлення товарів","reasons":"!@#$%^&*()_+`=-]\'/[;.,}\"?{:><\\\|Другое_ua ЛК","reason_comment":"!@#$%^&*()_+`-]\'/[;.,}\"?{:>\\\|абвгдеёжзийклмнопрстуфхцчшщъыьэюяєґїіАБВГДЕЁЖЗИЙКЛМНО","user_name":"Менеджер Розетки","link":"http://m2-front.dev.rozetka.com.ua/main/goods-manage/moderation?page=1&pageSize=20&id=2"},"requireAttachments":false}',
                ],
            ],
        ]
    ],
