...
return [
    ...
    'case2_1' => [
        ...
        'provider_data' => [
            'requestBody' => [
                ...
                'direction' => 1,
                'parent_id' => null,
                'planned_finish_date' => '2022-02-22 02:22:20',
                'priority' => 2,
                'rz_category_id' => null,
                'seller_id' => 128603,
            ...
            'RabbitMQWithRoutingKey' => [
                'lisa_common' => [
                    'create.requests.all' => [
                        ...
                        '","team_direction":4,"report_period_id":null,"sync_source_id":null,"sv_report_periods":null,"cross_check_status":null,"cross_check_manager_id":null,"employee_code_1c":null,"child_count":0,"photo_load_status":null,"previous_status":null,"supplier_cabinet_id":null,"payload":null,"rz_category_id":"4652996","author_team":17,"supervisor_team":14,"manager_team":null},"changed_fields_names":[]}'
                    ]
                ],
            ],
        ]
    ...
    'case6_2' => [
        ...
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'mock_data' => [
            'interior' => RequestsTester::interiorMockArray('request-create', 121212),
        ],
        'provider_data' => [
            'requestBody' => [
                '8' => true,
    ...
    'case14_0' => [
        ...
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'mock_data' => [
            'interior' => RequestsTester::interiorMockArray('request-create', 124276),
        ],
        'provider_data' => [
            'requestBody' => [
                '2' => true,
    ...
    'case20' => [
        'setting' => [
            'description' => 'Ошибка при создании заявки на Группировка товаров через шаблон c дочерними заявками с заблокированной категорией и приоритетом',
            'type' => 4,
            'direction' => 0
        ],
...
Заявка не сохранилась: Попытка установить заявке неактивный приоритет.
Также, возможно Вы пользуетесь шаблоном, который создает дочерние заявки, и неактивное значение в одной из них.',
                ],
            ],
            'db' => [
