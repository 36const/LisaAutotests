    ...
    'lisa_fixtures' => [
        ...
        'grid_settings' => [
            [
                ...
                'user_id' => 4,
                'columns_list' =>
                    '["report_period_id", "sv_report_periods", "result_comment", "supervisor_check_date", "calc_quantity_of_checked_goods", ' .
                    '"calc_quantity_of_checked_goods_with_errors", "calc_quantity_of_checked_goods_cc", "calc_quantity_of_checked_goods_with_errors_cc"]'
            ]
        ],
    ],
];