                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'old_value' => '{"description": "Супервайзер"}',
                            'new_value' => '{"description": "Суперпупервайзер"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 2,
                        ],
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "blockUser", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity' => 'auth.auth_item_child',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "takeToWork", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '[]',
                            'new_value' => '{"child": "createUser", "parent": "supervisor"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 1,
                        ],
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '[]',
                            'new_value' => '{"child": "requestViewTeamRequests", "parent": "supervisor"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 1,
                        ],
                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'entity' => 'auth.auth_item_child',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "requestViewDirectionRequests", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity' => 'auth.auth_item_child',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "requestCreateRelated", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '[]',
                            'new_value' => '{"child": "updateUser", "parent": "supervisor"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 1,
                        ],
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '[]',
                            'new_value' => '{"child": "viewUser", "parent": "supervisor"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 1,
                        ],
                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'entity' => 'auth.auth_item',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"project_id": 1}',
                            'new_value' => '{"project_id": 2}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 2,
                        ],
                        ...
                        [
                            ...
                            'entity' => 'auth.auth_item_child',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "requestViewAllRequests", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity' => 'auth.auth_item_child',
                            'entity_id' => 'supervisor',
                            'old_value' => '{"child": "errorsUpdate", "parent": "supervisor"}',
                            'new_value' => '[]',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 0,
                        ...
                        [
                            ...
                            'entity_id' => 'supervisor',
                            'old_value' => '[]',
                            'new_value' => '{"child": "commentRequestMrk", "parent": "supervisor"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 1,
                        ],
