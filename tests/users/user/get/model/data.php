...
return [
    'case1' => [
        'setting' => [
            'description' => 'Получить модель активного юзера СВ проект Контент (с категориями и продавцами)',
        ],
    ...
    'case2' => [
        'setting' => [
            'description' => 'Получить модель активного юзера СВ проект Контент (с категориями Rozetka)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'id' => 36,
    ...
    'case3' => [
        'setting' => [
            'description' => 'Получить модель активного юзера СВ проект Контент (с указанием в правиле)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'id' => 26,
    ...
    'case4' => [
        'setting' => [
            'description' => 'Получить модель активного юзера КМ проект Контент (с незакрытыми заявками статуса 5)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'id' => 11,
    ...
    'case5' => [
        'setting' => [
            'description' => 'Получить модель активного юзера КМ проект Контент (с незакрытыми заявками статуса 6)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'id' => 12,
    ...
    'case6' => [
        'setting' => [
            'description' => 'Получить модель активного юзера КМ проект Контент (с незакрытыми заявками статуса 7)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'id' => 13,
