...
return [
    'case1' => [
        ...
        'provider_data' => [
            ...
            'RabbitMQ' => [
                'lisa_common' => [
                    '{"action":"update","entity":"users","fields_data":{"id":5,"name":"Супервайзер Руководько 1","login":"bpm_headSupervisor_1","email":"bpm_headSupervisor_1@rozetka.com.ua","team":"8","parent_id":4,"position":"headSupervisor","status":1,"create_ts":"2020-04-13 13:15:33","created_by":1,"change_date":"' . date('Y-m-d'),
                    '{"action":"update","entity":"users","fields_data":{"id":6,"name":"Супервайзер Начальникович 1","login":"bpm_supervisor_1","email":"bpm_supervisor_1@rozetka.com.ua","team":"8","parent_id":5,"position":"supervisor","status":1,"create_ts":"2020-04-13 13:15:33","created_by":1,"change_date":"' . date('Y-m-d'),
                    '{"action":"update","entity":"users","fields_data":{"id":11,"name":"Менеджер Контентович 1А","login":"bpm_contentManager_1a","email":"bpm_contentManager_1a@rozetka.com.ua","team":"8","parent_id":6,"position":"contentManager","status":1,"create_ts":"2020-04-13 13:15:34","created_by":1,"change_date":"' . date('Y-m-d'),
