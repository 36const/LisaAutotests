 ...
 * @group lisa_api_priority
 * @group PUTPriorityUpdate
 */
class PUTPriorityUpdateCest
{
     ...
     */
    public function PUTPriorityUpdate(SettingsTester $I, Example $data)
    {
        ...
        $I->sendPUT('/priority/update/1', $providerData['requestBody']);
