 ...
 * @group POSTCategoryCreate
 */
class POSTCategoryCreateCest
{
     ...
     */
    public function POSTCategoryCreate(SettingsTester $I, Example $data)
    {
        ...
        $I->sendPOST('/category/create', $providerData['requestBody']);
