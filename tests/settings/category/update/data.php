                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'entity' => 'categories',
                            'entity_id' => 2,
                            'old_value' => '{"title": "Видео к товару", "status": 1, "difficulty": 3, "supervisor_id": 10}',
                            'new_value' => '{"title": "Видео к товару - new", "status": "0", "difficulty": "10", "supervisor_id": "6"}',
                            'user_id' => 4,
                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'entity' => 'categories',
                            'entity_id' => 2,
                            'old_value' => '{"difficulty": 3}',
                            'new_value' => '{"difficulty": "10"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 2,
                        ],
                ...
                'lisa_fixtures' => [
                    ...
                    'common_log' => [
                        [
                            ...
                            'entity' => 'categories',
                            'entity_id' => 2,
                            'old_value' => '{"title": "Видео к товару"}',
                            'new_value' => '{"title": "Видео к товару - new"}',
                            'user_id' => 4,
                            'created_at >=' => date('Y-m-d'),
                            'event' => 2,
                        ],
        ...
        'provider_data' => [
            ...
            'responseBody' => [
                'model' => [
                    ...
                    'title' => 'Видео к товару - new',
                    'difficulty' => '3',
                    'rz_categories_string' => 'Визитницы (<b>2514867</b>) | Бейджи, брелоки-идентификаторы, настольные таблички (<b>2514872</b>) | Банковские принадлежности (<b>2560747</b>) | Мини-бары (<b>4652996</b>) | Досточки для оттиска (<b>4655272</b>) | Штемпельная продукция (<b>2514877</b>) | Самонаборные штампы, кассы букв (<b>2898382</b>) | Штемпельные краски и подушки (<b>2898387</b>) | Датеры (<b>4628926</b>) | Оснастки, штампы стандартные (<b>4629073</b>)','supervisor_id' => 'Супервайзер Начальникович 2',
                    'status' => 'Активный',
                ],
            ],
            'db' => [
