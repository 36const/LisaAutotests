...
return [
    ...
    'case6' => [
        'setting' => [
            'description' => 'Получить причины с фильтром по типам и направлениям и обратной сортировкой по комментарию (укр.)',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestParameters' => [
                'filter[type_directions][0]' => '[3,1]',
                'filter[type_directions][1]' => '[3,2]',
                'filter[type_directions][2]' => '[4,0]',
                'sort' => '-comment_is_required'
            ],
            'responseBody' => [
                'data' => [
                    'models' => [
                    ...
                    '_links' => [
                        'self' => [
                            'href' => 'http://lisa-api.docker/reason/list?filter%5Btype_directions%5D%5B0%5D=%5B3%2C1%5D&filter%5Btype_directions%5D%5B1%5D=%5B3%2C2%5D&filter%5Btype_directions%5D%5B2%5D=%5B4%2C0%5D&sort=-comment_is_required&page=1',
                        ],
                        'first' => [
                            'href' => 'http://lisa-api.docker/reason/list?filter%5Btype_directions%5D%5B0%5D=%5B3%2C1%5D&filter%5Btype_directions%5D%5B1%5D=%5B3%2C2%5D&filter%5Btype_directions%5D%5B2%5D=%5B4%2C0%5D&sort=-comment_is_required&page=1',
                        ],
