...
return [
    'case2' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 1 при наличии других заявок',
        ],
    ...
    'case4' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 3',
        ],
    ...
    'case6' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 5',
        ],
    ...
    'case8_2' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 7 ризон 2',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case8_2.php',
        'provider_data' => [
            'requestParameters' => [
                'requestId' => '1'
            ],
    ...
    'case8_1_2' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 7 ризоны 1 и 2',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case8_1_2.php',
        'provider_data' => [
            'requestParameters' => [
                'requestId' => '1'
            ],
    ...
    'case10' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 9',
        ],
    ...
    'case12' => [
        'setting' => [
            'description' => 'Заявка тип 1 направление 2 статус 6 с проставленным photo_load_status',
        ],
        ...
        'provider_data' => [
            ...
            'responseBody' => [
                'status' => 400,
                'errors' => [
                    "У заявки №1 статус загрузки фото уже 'Загружены на OWOX'"
                ]
            ],
            'db' => [
                'lisa_fixtures' => [
    ...
    'case18' => [
        'setting' => [
            'description' => 'Заявка тип 3 направление 2 статус 3',
        ],
    ...
    'case21' => [
        'setting' => [
            'description' => 'Заявка тип 6 направление 2 статус 6',
        ],
    ...
    'case13' => [
        ...
        'provider_data' => [
            ...
            'responseBody' => [
                'status' => 400,
                'errors' => [
                    'Заявка с таким ID не существует.'
                ]
            ],
            'db' => [
                'lisa_fixtures' => [
    ...
    'case15' => [
        'setting' => [
            'description' => 'Параметр без значения',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestParameters' => [
    ...
    'case17' => [
        ...
        'provider_data' => [
            ...
            'responseBody' => [
                'status' => 400,
                'errors' => [
                    "Статус загрузки фото можно присвоить только задачам направления 'Работа с товарами Маркетплейса'"
                ]
            ],
            'db' => [
                'lisa_fixtures' => [
    ...
    'case1' => [
        'setting' => [
            'description' => 'Невозможность присвоить статус загрузки фото тип 1 направление 1 статус 1 при наличии других заявок',
        ],
        'fixture_data' => include __DIR__ . '/fixture/case1.php',
        'provider_data' => [
            'requestParameters' => [
    ...
    'case7' => [
        'setting' => [
            'description' => 'Невозможность присвоить статус загрузки фото тип 1 направление 1 статус 6',
        ],
    ...
    'case11' => [
        'setting' => [
            'description' => 'Невозможность присвоить статус загрузки фото тип 1 направление 1 статус 11',
        ],
    ...
    'case9' => [
        'setting' => [
            'description' => 'Невозможность присвоить статус загрузки фото тип 1 направление 1 статус 8',
        ],
